...
GitHub Personal Access Token был найден в коммите и отправлен на GitHub.

**Дата обнаружения:** 2025-12-26  
**Токен:** `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`  
**Коммит:** `d41fa3f30c4db12ecff1dd0684e519efe4bf8535`  
**Статус:** 🔴 **КРИТИЧНО** - Токен скомпрометирован, требуется немедленная ротация
