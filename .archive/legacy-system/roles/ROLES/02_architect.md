...
#### SPEC-DRIVEN режим (ОСНОВНОЙ для новых фич)
**Когда использовать:** Для новых фич, изменений в существующих фичах, архитектурных изменений
...
4. **Правила SPEC-DRIVEN режима:**
   - ❌ НЕ пиши код реализации
   - ✅ Только план, анализ, архитектурные решения
   - ✅ Учитывай `.specify/constitution.md` для стандартов
