...
describe('UserModel', () => {
    ...
    describe('getById', () => {
        it('should get user by ID', async () => {
            ...
            const user = await User_1.UserModel.getById(mockUser.user_id);
        ...
        it('should return null if user not found', async () => {
            ...
            const user = await User_1.UserModel.getById('non-existent-id');
    ...
    describe('getByEmail', () => {
        it('should get user by email', async () => {
            ...
            const user = await User_1.UserModel.getByEmail(mockUser.email);
            expect(user).toEqual(mockUser);
