...
const Subscription_1 = require("../../db/models/Subscription");
...
async function getCurrentSubscription(req, res) {
    try {
        ...
        const subscription = await Subscription_1.SubscriptionModel.getByUserId(req.user.sub);
        if (!subscription) {
...
async function createSubscription(req, res) {
    try {
        ...
        // Update user tier
        await User_1.UserModel.update(user.user_id, { tier: tier });
...
async function cancelSubscription(req, res) {
    try {
        ...
        // Update in DynamoDB
        const updated = await Subscription_1.SubscriptionModel.update(req.user.sub, subscription.subscription_id, {
            cancel_at_period_end: true,
